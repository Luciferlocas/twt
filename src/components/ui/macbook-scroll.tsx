...
export const MacbookScroll = ({
  ...
  return (
    <div
      ref={ref}
      className="min-h-[100vh] flex flex-col items-center py-0 md:py-20 justify-start flex-shrink-0 [perspective:800px] transform md:scale-100  scale-[0.35] sm:scale-50"
    >
      <motion.h2
        style={{
      ...
      >
        {title || (
          <>
            ...
            <p className="w-[40em]  text-zinc-200">
            ...
            <div className="text-left text-[0.8em] text-zinc-500 underline my-8">
              <a href="https://developer.twitter.com/en" target="blank">
                Click get your keys from here
              </a>
            </div>

            <div className="text-white flex text-[0.6em] justify-around mt-8">
              <a
                href="https://github.com/EuclidStellar/twitter-cli-golang/releases/download/V1.0.2/twt.exe"
                className="bg-gray-900 px-4 py-2 rounded-xl"
              >
                Windows
              </a>
              <a
                href="https://github.com/EuclidStellar/twitter-cli-golang/releases/download/V1.0.2/twt_linux"
                className="bg-gray-900 px-4 py-2 rounded-xl"
              >
                Linux
              </a>
              <a
                href="https://github.com/EuclidStellar/twitter-cli-golang/releases/download/V1.0.2/twt_macos"
                className="bg-gray-900 px-4 py-2 rounded-xl"
              >
                Mac OS
              </a>
    ...
    <div className="relative [perspective:800px]">
      ...
      >
        ...
        <Image
          ...
          alt="aceternity logo"
          fill
          className="object-cover object-left-top absolute rounded-lg inset-0 h-full w-full mb-20"
        />
      </motion.div>
    </div>
  );
